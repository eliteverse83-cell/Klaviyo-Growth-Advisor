    ...
    <section className="relative overflow-hidden bg-hero-gradient">
      <Container className="relative py-20 sm:py-28 lg:py-32">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="animate-fade-up animate-delay-1 mt-6 text-4xl font-bold tracking-tight text-ink-900 sm:text-5xl lg:text-6xl">
            Find the revenue hiding in your{' '}
            <span className="text-gradient">Shopify &amp; Klaviyo</span> data
          </h1>

          <p className="animate-fade-up animate-delay-2 mt-6 text-lg leading-8 text-ink-500 sm:text-xl">
          ...
          <div className="animate-fade-up animate-delay-4 mt-14 flex flex-col items-center justify-center gap-x-8 gap-y-3 text-sm text-ink-500 sm:flex-row">
